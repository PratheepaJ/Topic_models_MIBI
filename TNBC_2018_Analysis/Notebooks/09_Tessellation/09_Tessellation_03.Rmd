...
tessllation_space_12 <- tmap::tm_shape(dir_poly_p4) +
  tmap::tm_polygons(
    col = "numTumor",
    title = "Number of \ntumors cells",
    style = "jenks",
...
tessllation_space_12
# tmap::tmap_save(tm=tessllation_space_12, filename = "tessllation_space_12.eps",
#                 width = 8, height = 5)
```
...
```{r}
map_poly_p12_queen <- tmap::tm_shape(dir_poly_p4) + 
  tmap::tm_polygons(col = "Z.Ii", 
    ...
    tmap::tm_layout(legend.outside = TRUE,
                  legend.outside.position = "right")
map_poly_p12_queen
# tmap::tmap_save(tm=map_poly_p12_queen, filename = "map_poly_p12_queen.eps",
#                 width = 8, height = 5)
```
