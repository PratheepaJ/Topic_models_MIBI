...
## Patient 1
```{r}
spe_p4 <- spe[ ,spe$sample_id == "Sample_12"]
...
# tmap::tmap_save(tm=tessllation_space, filename = "tessllation_space_12.eps",
#                 width = 8, height = 5)
```
...
# tmap::tmap_save(tm=map_poly_p4_queen, filename = "map_poly_p12_queen.eps",
#                 width = 8, height = 5)
```
