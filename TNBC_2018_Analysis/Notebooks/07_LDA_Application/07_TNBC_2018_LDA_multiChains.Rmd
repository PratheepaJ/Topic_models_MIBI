...
```{r}
# #p_topicProp <- TNBC_2018_LDA_5_2000$plot_topic_prop
# #p_cellTypeDist <- TNBC_2018_LDA_5_2000$plot_cellType_prop
# p <- ggpubr::ggarrange(
#   p_topicProp, p_cellTypeDist,
#   labels = "AUTO",
#   widths = 10, heights = c(4, 5),
...
```{r}
# TNBC_2018_LDA_5_2000$plot_model_assessment
# ggsave(filename = "assess_plots.eps", device = "eps",
#        width = 10, height = 6,
#        path = here::here("Output", "Figures"))
```
...
# TNBC_2018_LDA_5_2000$plot_topic_prop
# TNBC_2018_LDA_5_2000$plot_cellType_prop
```
